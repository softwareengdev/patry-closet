...
const mockBlogPosts = [
    {
        ...
        content: `
            ...
            <img src="https://images.unsplash.com/photo-1509631179647-0177331693ae?auto=format&fit=crop&w=800&q=80" alt="Boho Chic 2025" className="w-full h-64 object-cover mb-4" />
            ...
            <img src="https://images.unsplash.com/photo-1520974735194-8d95cdf6d2ef?auto=format&fit=crop&w=800&q=80" alt="Siluetas Oversize 2025" className="w-full h-64 object-cover mb-4" />
            ...
            <img src="https://images.unsplash.com/photo-1594633312681-86309903deb9?auto=format&fit=crop&w=800&q=80" alt="Encajes 2025" className="w-full h-64 object-cover mb-4" />
            ...
            <img src="https://images.unsplash.com/photo-1618366712010-f4ae9c647dcb?auto=format&fit=crop&w=800&q=80" alt="Lentejuelas 2025" className="w-full h-64 object-cover mb-4" />
            ...
            <img src="https://images.unsplash.com/photo-1529139574466-a303d20ff24f?auto=format&fit=crop&w=800&q=80" alt="Polka Dots 2025" className="w-full h-64 object-cover mb-4" />
...
const Blog = () => {
    ...
    return (
        <section className="py-20 sm:py-28 bg-warm-100 dark:bg-gray-950 min-h-screen">
            <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-10">
                <span className="text-[11px] font-medium uppercase tracking-ultra-wide text-gray-400 mb-3 block text-center">{t('ourBlog')}</span>
                <h1 className="text-3xl sm:text-4xl lg:text-5xl font-serif font-light tracking-tight text-center mb-12 text-gray-800 dark:text-gray-200">{t('ourBlog')}</h1>
                <div className="space-y-16">
                    {mockBlogPosts.map(post => (
                        <motion.article
                            ...
                            className="bg-warm-50 dark:bg-gray-800 p-8 border border-warm-300 dark:border-gray-800 shadow-2xl"
                        >
